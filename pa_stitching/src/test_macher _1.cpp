...
{ /********Ros*******/
  ...
  /************************Project**************************/
  img_left=imread("/home/wds/catkin_ws/src/pa_stitching/data/SPHP-campus-ori/campus_01.jpg");
  img_right=imread("/home/wds/catkin_ws/src/pa_stitching/data/SPHP-campus-ori/campus_02.jpg");
#if Gettime
...
// 	
	...
	for (int i = 0; i < 360; ++i)
     ...
     imwrite("/home/wds/catkin_ws/src/pa_stitching/data/SPHP-campus/segnet_left.jpg",segnet_left);
     imwrite("/home/wds/catkin_ws/src/pa_stitching/data/SPHP-campus/segnet_right.jpg",segnet_right);
...
void Img_Fusion()
{
  ...
  while(ros::ok())
  {
    ...
    vector<Point2f> points1; KeyPoint::convert(Th2_keypoints1, points1, queryIdxs);  
    vector<Point2f> points2; KeyPoint::convert(Th2_keypoints2, points2, trainIdxs);  
